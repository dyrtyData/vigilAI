...
def generate_default_config_yaml(task_dir: Path) -> str:
    ...
    lines = [
        ...
        "# ================================",
        "# This file shows all vigilAI tasks with configurable arguments and their default values.",
        "# To customize the configuration you can copy this file and modify it.",
        "# Usage: vigilai eval <model> --task-config default_config.yaml",
        "#",
...
def main(
    task_dir: Path = Path(__file__).parent.parent / "src" / "vigilai" / "tasks",
