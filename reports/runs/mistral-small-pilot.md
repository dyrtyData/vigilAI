...
- **Model(s):** ollama/mistral-small:latest
- **Log directory:** `logs/ollama_mistral-small:latest_2026-06-21T11-03-01-03-00`
...
| Art. 5, III | all_ai | `bbq_brazil` | Representation — Absence of Bias | 0.650 |
| **Art. 5, III — mean** | all_ai |  |  | **0.650** |
...
|---|---|---|---|---|---|
| `bbq_brazil` | Art. 5, III (all_ai) | 0.650 | `bbq` | 0.600 | +0.050 |
