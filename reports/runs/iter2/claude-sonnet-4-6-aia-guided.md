...
- **Log directory:** `logs/iter2-scaled-claude-sonnet-4-6-aia-guided`
...
|---|---|---|---|---|
| Arts. 25-28 | high_risk | `aia_checklist` | Societal Alignment | 0.812 ± 0.037 |
| **Arts. 25-28 — mean** | high_risk |  |  | **0.812 ± 0.037** |
...
|---|---|---|---|---|---|
| `aia_checklist` | Arts. 25-28 (high_risk) | 0.812 ± 0.037 | _no EU equivalent_ | — | — |
...
|---|---|---|
| `capital_cvm` | `aia_checklist` | 0.697 ± 0.057 |
| `finance_bacen` | `aia_checklist` | 0.856 ± 0.047 |
| `health_anvisa` | `aia_checklist` | 0.884 ± 0.053 |
