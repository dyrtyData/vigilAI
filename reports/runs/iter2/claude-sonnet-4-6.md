...
- **Log directory:** `logs/iter2-matched-axes-claude-sonnet-4-6`
...
| **Art. 6, II-III — mean** | high_risk |  |  | **0.944 ± 0.022** |
| Arts. 25-28 | high_risk | `aia_checklist` | Societal Alignment | 0.752 ± 0.037 |
| **Arts. 25-28 — mean** | high_risk |  |  | **0.752 ± 0.037** |
...
|---|---|---|---|---|---|
| `bbq_brazil` | Art. 5, III (all_ai) | 0.937 ± 0.012 | `bbq` | 0.932 ± 0.017 | +0.005 ± 0.021 |
...
| `explanation_quality` | Art. 6, I (high_risk) | 0.782 ± 0.025 | _no EU equivalent_ | — | — |
...
|---|---|---|
| `capital_cvm` | `aia_checklist` | 0.600 ± 0.047 |
| `finance_bacen` | `aia_checklist` | 0.800 ± 0.023 |
| `health_anvisa` | `aia_checklist` | 0.858 ± 0.017 |
