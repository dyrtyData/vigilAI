...
from vigilai.tasks.mmmu_pro.utils import get_images_in_order
from vigilai.tasks.mmmu_pro.utils import image_to_data_uri
from vigilai.tasks.mmmu_pro.utils import replace_image_tokens
