...
from vigilai.tasks.self_check_consistency.compact_ie.inputs.dataset_readers.oie_reader_for_ent_rel_decoding import (
    OIE4ReaderForEntRelDecoding,
)
from vigilai.tasks.self_check_consistency.compact_ie.inputs.datasets.dataset import (
    Dataset,
)
from vigilai.tasks.self_check_consistency.compact_ie.inputs.fields.map_token_field import (
    MapTokenField,
)
from vigilai.tasks.self_check_consistency.compact_ie.inputs.fields.raw_token_field import (
    RawTokenField,
)
from vigilai.tasks.self_check_consistency.compact_ie.inputs.fields.token_field import (
    TokenField,
)
from vigilai.tasks.self_check_consistency.compact_ie.inputs.instance import Instance
from vigilai.tasks.self_check_consistency.compact_ie.inputs.vocabulary import Vocabulary
from vigilai.tasks.self_check_consistency.compact_ie.models.joint_decoding.joint_decoder import (
    EntRelJointDecoder,
)
from vigilai.tasks.self_check_consistency.compact_ie.models.relation_decoding.relation_decoder import (
    RelDecoder,
)
from vigilai.tasks.self_check_consistency.compact_ie.utils.prediction_outputs import (
