...
from vigilai.tasks.self_check_consistency.compact_ie.models.embedding_models.bert_embedding_model import (
    BertEmbedModel,
)

# from vigilai.tasks.self_check_consistency.compact_ie.models.embedding_models.pretrained_embedding_model import (
#     PretrainedEmbedModel,
# )
# from vigilai.tasks.self_check_consistency.compact_ie.modules.token_embedders.bert_encoder import (
#     BertLinear,
# )
from vigilai.tasks.self_check_consistency.compact_ie.modules.token_embedders.bert_encoder import (
    BertLayerNorm,
