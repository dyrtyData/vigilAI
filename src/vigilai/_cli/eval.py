...
from vigilai._cli.utils import bool_or_float
from vigilai._cli.utils import error_handler
from vigilai._cli.utils import get_log_dir
from vigilai._cli.utils import get_task_infos
from vigilai._cli.utils import instantiate_tasks_from_infos
from vigilai._cli.utils import parse_sample_id
from vigilai._cli.utils import parse_samples_limit
from vigilai._cli.utils import parse_task_args
from vigilai._cli.utils import patch_display_results
from vigilai._cli.utils import validate_model_args
...
def eval_command(
    ...
    tasks: Annotated[
        ...
        typer.Option(
            "-t",
            "--tasks",
            help="Comma-separated list of tasks to run. If not provided, all vigilAI tasks are run.",
            envvar="VIGILAI_TASKS",
        ),
    ] = None,
    ...
    task_config: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_TASK_CONFIG",
        ),
    ] = None,
    model_base_url: Annotated[
        str | None,
        typer.Option(
            help="Base URL for for model API.", envvar="VIGILAI_MODEL_BASE_URL"
        ),
    ] = None,
    ...
    retry_connections: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_RETRY_CONNECTIONS",
        ),
    ] = 1.0,
    ...
    sample_shuffle: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_SAMPLE_SHUFFLE",
        ),
    ] = None,
    epochs: Annotated[
        int | None,
        typer.Option(
            help="Number of times to repeat each sample.", envvar="VIGILAI_EPOCHS"
        ),
    ] = None,
    max_tokens: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_MAX_TOKENS",
        ),
    ] = 4096,
    temperature: Annotated[
        float | None,
        typer.Option(help="Model temperature.", envvar="VIGILAI_TEMPERATURE"),
    ] = None,
    top_p: Annotated[
        float | None, typer.Option(help="Model top-p.", envvar="VIGILAI_TOP_P")
    ] = None,
    top_k: Annotated[
        int | None,
        typer.Option(
            help="Randomly sample the next word from the top_k most likely next words. Anthropic, Google, HuggingFace, and vLLM only.",
            envvar="VIGILAI_TOP_K",
        ),
    ] = None,
    seed: Annotated[
        int | None,
    ...
    reasoning_effort: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_REASONING_EFFORT",
        ),
    ] = None,
    reasoning_tokens: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_REASONING_TOKENS",
        ),
    ] = None,
    cache: Annotated[
        str | None,
    ...
    max_connections: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_MAX_CONNECTIONS",
        ),
    ] = 10,
    ...
    max_subprocesses: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_MAX_SUBPROCESSES",
        ),
    ] = None,
    ...
    max_tasks: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_MAX_TASKS",
        ),
    ] = 2,
    display: Annotated[
        Literal["full", "rich", "plain", "log", "none"],
        typer.Option(help="Display type.", envvar="VIGILAI_DISPLAY"),
    ] = "full",
    log_level: Annotated[
        Literal["debug", "trace", "http", "info", "warning", "error", "critical"],
        typer.Option(
            help="Python logger level for console.", envvar="VIGILAI_LOG_LEVEL"
        ),
    ] = "warning",
    log_dir: Annotated[
        str, typer.Option(help="Directory to save logs to.", envvar="VIGILAI_LOG_DIR")
    ] = "./logs/",
    log_samples: Annotated[
        bool, typer.Option(help="Log sample details", envvar="VIGILAI_LOG_SAMPLES")
    ] = True,
    log_buffer: Annotated[
        int | None,
        typer.Option(
            help="Number of samples to buffer before writing log file.",
            envvar="VIGILAI_LOG_BUFFER",
        ),
    ] = 1000,
    log_format: Annotated[
        Literal["eval", "json"],
        typer.Option(help="Format for writing log files.", envvar="VIGILAI_LOG_FORMAT"),
    ] = "eval",
    ...
    continue_on_fail: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_CONTINUE_ON_FAIL",
        ),
    ] = False,
    ...
    log_dir_allow_dirty: Annotated[
        ...
        typer.Option(
            ...
            envvar="VIGILAI_LOG_DIR_ALLOW_DIRTY",
        ),
    ] = False,
    debug: Annotated[
        bool,
        typer.Option(
            "--debug", help="Enable full stack traces.", envvar="VIGILAI_DEBUG"
        ),
    ] = False,
) -> None:
    """Run tasks."""
